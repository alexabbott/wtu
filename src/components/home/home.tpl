...
<div class="home" ng-init="init()">
  ...
  <section class="intro__bg">
		...
		<video ng-src="{{ data.home.intro_video }}" muted poster="{{data.home.intro_image.url}}" class="intro__video no-opacity" ng-show="data.home.intro_video" autoplay playsinline loop></video>
